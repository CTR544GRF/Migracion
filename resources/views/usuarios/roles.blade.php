...
@section('seccion')
<form class="registrar_usuario" action="{{route('roles.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <table class="table table-bordered">
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <form action="{{route('roles.destroy',$rol)}}" method="post" class="eliminar_datos">
                    @csrf
                    @method('delete')
            ...
            <div class="modal_actualizar_{{$rol->cod_rol}}" data-modal="{{$rol->cod_rol}}">
                <div class="container_form_actualizar">
                    ...
                    <form class="actualizar_rol" action="{{route('roles.edit',$rol)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form_container">
                            <div class="from_group">
                                <input type="text" id="cod_rol" class="from_input" placeholder="codigo de rol" name="codigo" value="{{$rol->cod_rol}}" readonly onmousedown="return false;">
                            </div>
                            <div class="from_group">
                                <input type="text" id="nom_rol" class="from_input" placeholder="Nombre de rol" name="nombre" value="{{$rol->nom_rol}}" required>
                            </div>
                            <div class="from_group">
